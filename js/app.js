//aqui você deve codificar as ações conforme descrito no enunciado do projeto


//Ponto  1- Mudar a cor do título e alternar
...
//Ponto 2 - Função para gerar números aleatórios
...
// Obter filas ou colunas de doces
...
//Ponto 3 - Validar se há doces que foram eliminados em uma coluna
...
// Validar se há doces que devem ser eliminados em uma linha
...
//Contador de pontuação - Mostra a Pontuação
...
//Se tiverem doces para serem eliminados
...
//Ponto 7 - Intereção do usuário com o elemento doce é "drag and drop"
//Efeito de movimento entre os doces
function addCandyEvents() {
	$('img').draggable({
		containment: '.painel-tabuleiro',
		droppable: 'img',
		revert: true,
		revertDuration: 500,
		grid: [100, 100],
...
//Deixa o doce sólido ao se mover
...
//Valida a pontuação de acordo com a quantidade de elementos em cada linha
function updateMoves() {
	var actualValue = Number($('#movimentos-text').text());
	var result = actualValue += 1;
	$('#movimentos-text').text(result);
}

//Eliminação automática dos elementos
...
//Preenche os espaços com elementos automaticamente
...
//Pontos 4 e 6 - Temporizador e reiniciar
//Muda a aparência da página
//Fim de jogo
function endGame() {
	$('div.painel-tabuleiro, div.time').effect('fold');
	$('h1.main-titulo').addClass('title-over')
		.text('Gracias por jugar!');
	$('div.score, div.moves, div.painel-score').width('100%');
